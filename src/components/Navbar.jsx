...
export default function CustomNavbar() {
  ...
  return (
    <Navbar bg="light" expand="lg" className="border-bottom fixed-top px-3 py-0">
        ...
        <div className="d-flex align-items-center gap-3 position-relative">
          ...
          {showModal && searchRef.current && (
            <div className="scrollbar-hidden"
              style={{
                position: "absolute",
                top: searchRef.current.getBoundingClientRect().bottom + window.scrollY,
            ...
            >
              <SearchModal results={results} searchTerm={searchTerm} loading={loading} onClose={() => setShowModal(false)} />
            </div>
          )}
        </div>
          ...
          <Row className="g-3 text-center ms-auto text-center d-flex flex-sm-row align-items-sm-center">
            ...
            <Col xs={4} md="auto" className="d-none d-md-block">
              <div className="dropdown">
                ...
                <ul
                  className={addFlex ? 'dropdown-menu d-flex aziende dropdown-menu-end justify-content-between' : 'dropdown-menu aziende dropdown-menu-end justify-content-between'}
                >
